...
<Segment textAlign='left' className='mainCard'>
                        ...
                        <p style={{textAlign: 'center'}}>Done this hike before? Mark it as completed</p>
                        <Button style={{marginLeft: "37%"}} color='olive' onClick={() => itsCompleted(hl)}>Mark as completed</Button>
                        <Button color='olive' onClick={handleSeeMore}> {visible ? 'See Less' : 'See More'}</Button>
